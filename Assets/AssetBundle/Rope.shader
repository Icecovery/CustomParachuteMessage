    ...
    SubShader {
        ...
        Pass {
            ...
            UNITY_INSTANCING_BUFFER_START( Props )
                ...
                UNITY_DEFINE_INSTANCED_PROP( float, _ambientLight)
...
/////// Diffuse:
                ...
                indirectDiffuse += _ambientLight_var * lightColor * _LightColor0.w; // Diffuse Ambient Light
